    ...
    <div className={clsx(classes.root, className)} {...rest}>
      <Grid container data-aos="fade-up">
        <Grid item container alignItems="flex-start" xs={12} md={4}>
          <Image
            src="/images/photos/ecommerce/overview-cover-left.png"
            srcSet="/images/photos/ecommerce/overview-cover-left@2x.png 2x"
        ...
        <Grid item container justify="flex-end" xs={12} md={4}>
          <Image
            src="/images/photos/ecommerce/overview-cover-right.png"
            srcSet="/images/photos/ecommerce/overview-cover-right@2x.png 2x"
